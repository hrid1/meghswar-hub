...
// export const allParcelColumns = (onClickUpdate?: (row: any) => void) => [
//   // 1. Parcel ID
//   {
//     key: "parcelId",
//     header: "ID",
...
//             ? da
//             : typeof da === "object"
//               ? [da.area, da.zone, da.city].filter(Boolean).join(", ") || txt(da.division) || "—"
//               : "—";
...
//         <button className="px-2 py-1 text-xs bg-green-500 text-white rounded-md hover:bg-green-600 transition-colors">
