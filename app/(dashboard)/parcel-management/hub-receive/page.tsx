...
import { mockParcels1 } from "../hub-transfer/_components/mockData";
import { parcelColumns1 } from "../hub-transfer/_components/ParcelCol";
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between gap-4 mb-4">
        ...
        <Button className="bg-orange-500">Receive Transfers</Button>
      </div>
